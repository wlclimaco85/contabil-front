...
qat.model.fnFormaReceber = function(_oObjet, _action) {
    ...
    return cnaes = {
        ...
        formaCadastro: _oObjet.formaCadastro ? qat.model.fnDoisValor(
            _oObjet.formaCadastro ? _oObjet.formaCadastro : {}, _action) : null,
...
qat.model.fnNFNotaInfoIdentificacao = function(_NFNotaInfoIdentificacao,
    ...
    NFNotaInfoIdentificacao = {
        ...
        modelo: _NFNotaInfoIdentificacao.modelo ? qat.model.fnDoisValor(_NFNotaInfoIdentificacao.modelo, modelAction) : { id: 10 },
        serie: _NFNotaInfoIdentificacao.serie ? qat.model.fnDoisValor(_NFNotaInfoIdentificacao.serie, modelAction) : { id: 10 },
