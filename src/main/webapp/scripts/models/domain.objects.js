...
qat.model.fnFormaPagar = function(_oObjet,_action)
{
    ...
    return     cnaes    = {
              ...
              dataEmissao    : _oObjet.dataEmissao ? new Date(_oObjet.dataEmissao).getTime() : null,
              dataVencimento : _oObjet.dataVencimento ? new Date(_oObjet.dataVencimento).getTime() : null,
              dataPagamento  : _oObjet.dataPagamento ? new Date(_oObjet.dataPagamento).getTime() : null,
              docId          : _oObjet.docId,
              ...
              listBaixa      : [qat.model.fnBaixaTitulo(_oObjet.listBaixa[0],_action)],
