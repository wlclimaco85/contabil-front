(function() {
    angular.module('wdApp.apps.doisValores', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
        .controller('ClienteController', doisValoresController);

    function doisValoresController($scope, $compile, DTOptionsBuilder, DTColumnBuilder, ModalService, $rootScope, SysMgmtData, TableCreate,Datatablessss,tableOptionsFactory,tableColumnsFactory,FiltersFactory) {
        var vm = this;
        vm.selected = {};
        vm.selectAll = false;
...
(function() {
    angular.module('wdApp.apps.doisValores.insert', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
...
(function() {
    angular.module('wdApp.apps.doisValores.update', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
...
(function() {
    angular.module('wdApp.apps.doisValores.delete', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
...
(function() {
    angular.module('wdApp.apps.doisValores.view', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
...
(function() {
    angular.module('wdApp.apps.doisValores.search', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
