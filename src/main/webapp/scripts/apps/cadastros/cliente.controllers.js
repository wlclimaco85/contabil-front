(function() {
    ...
    function clienteController($scope, $compile, DTOptionsBuilder, DTColumnBuilder, ModalService, $rootScope, SysMgmtData, Datatablessss, dialogFactory) {
        var vm = this;
        vm.selected = {};
        vm.selectAll = false;
        ...
        var oOptions = DTOptionsBuilder.newOptions()
            ...
            .withButtons([{
                ...
                action: function(e, dt, node, config) {
                    ...
                    dialogFactory.dialog('views/cadastros/dialog/dCliente.html',"ClienteInsertController",openDialogUpdateCreate);
