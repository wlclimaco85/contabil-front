(function() {
    angular.module('wdApp.apps.orcamento', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
        .controller('OrcamentoController', orcamentoController);

    function orcamentoController($scope, $compile, DTOptionsBuilder, DTColumnBuilder, ModalService, $rootScope, SysMgmtData, Datatablessss, dialogFactory, tableColumnsFactory, tableOptionsFactory, FiltersFactory) {
        var vm = this;
        vm.selected = {};
        vm.selectAll = false;
        ...
        function reloadData() {
            ...
            vm.dtInstanceOrcamento.reloadData(callback, resetPaging);
        }
        ...
        $rootScope.reloadDataSit = function(_callback) {
            ...
            var resetPaging = false;
            vm.dtInstanceOrcamento.reloadData(_callback, resetPaging);
        }
    ...
    angular.module('wdApp.apps.orcamento.insert', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
        .controller('OrcamentoInsertController', function(localStorageService, $rootScope, $scope, fModels, SysMgmtData, doisValorFactory, fNotaFiscal) {
            ...
            $scope.saveOrcamento = function() {
                ...
                fNotaFiscal.fnCreateObjectOrcamentoOrcamento(localStorageService.get('empresa'), $scope.pessoa, $scope.endereco, $scope.produtos, $scope.formaPg, $scope.notaFiscalSaida, 1, 'INSERT', 1001, $scope.financeiros);
            };
...
(function() {
    angular.module('wdApp.apps.orcamento.update', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
        .controller('OrcamentoUpdateController', function($rootScope, $scope, fModels, SysMgmtData, fPessoa) {
            ...
            $scope.saveOrcamento = function() {
                fPessoa.fnMontaObjeto($scope.orcamento, $scope.endereco, 'UPDATE', "site/api/orcamento/update/", fnCallBack);
            }
        });
})();
(function() {
    angular.module('wdApp.apps.orcamento.delete', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
        .controller('OrcamentoDeleteController', function($rootScope, $scope, fModels, SysMgmtData, fPessoa) {
            ...
            console.log($rootScope.orcamento)
            $scope.saveOrcamento = function() {
                fPessoa.fnDelete($scope.orcamento, "site/api/orcamento/update/", function() {
...
(function() {
    angular.module('wdApp.apps.orcamento.view', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
        .controller('OrcamentoViewController', function($rootScope, $scope, fModels, SysMgmtData, fPessoa) {
            ...
            console.log($rootScope.orcamento)
            $scope.saveOrcamento = function() {
                fPessoa.fnOpenView($scope.orcamento, "site/api/orcamento/update/", function() {
                    console.log('aqui')
                });
            }
        });
