(function()
{
	...
	angular.module('wdApp.apps.select.cnae', ['ngSanitize', 'ui.select'])
		...
		}).controller('CnaeSelectControllers', cnaeSelectControllers);
	...
	function cnaeSelectControllers($scope, $http, $timeout, $interval)
	{
		...
		$scope.createcnae = function(type)
		{
			...
			$scope.cnaes.push(
			{
				nome: 'cnae1' + ($scope.cnaes.length + 1),
				cnae:
				{
					id: type
				}
