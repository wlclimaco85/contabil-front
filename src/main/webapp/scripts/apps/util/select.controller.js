(function() {
    angular.module('wdApp.apps.select', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter','ngSanitize', 'ui.select'])
        .controller('SelectControllers', selectController);

    function selectController($scope, $http, $timeout, $interval) {
        var vm = this;
