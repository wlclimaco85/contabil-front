...
(function() {
    angular.module('wdApp.apps.pdCompras.view', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter','colorpicker.module'])
        .controller('KitchenSinkCtrl', function($rootScope, $scope, fModels, SysMgmtData, fPessoa) {
