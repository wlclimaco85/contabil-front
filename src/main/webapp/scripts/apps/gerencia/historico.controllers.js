(function() {
    angular.module('wdApp.apps.historico', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
        .controller('HistoricoController', historicoController);

    function historicoController($scope, $compile, DTOptionsBuilder, DTColumnBuilder, ModalService) {
        var vm = this;
        vm.selected = {};
        vm.selectAll = false;
