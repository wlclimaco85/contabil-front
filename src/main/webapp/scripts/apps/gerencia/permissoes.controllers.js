(function() {
    angular.module('wdApp.apps.permissoes', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
        .controller('PermissoesController', permissoesController);

    function permissoesController($scope, $compile, DTOptionsBuilder, DTColumnBuilder, ModalService) {
        var vm = this;
        vm.selected = {};
        vm.selectAll = false;
