...
(function()
{
	angular.module('wdApp.apps.newEmpresa.update', ['datatables', 'angularModalService', 'datatables.buttons', 'datatables.light-columnfilter'])
		.controller('NewEmpresaUpdateController', function($rootScope, $scope, fModels, SysMgmtData, fEmpresa, $log, doisValorFactory,validationFactory)
		{
			...
			fEmpresa.fnViewDialog(vm,$scope);
