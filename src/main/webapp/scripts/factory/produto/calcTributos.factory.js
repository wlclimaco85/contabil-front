			...
			return {
				fnCalcTributo : function (scope) {
					...
					for (var x = 0; x < _produtos.length; x++) {
						...
						if (_produto.tributacao.imposto.pis.aliquota.situacaoTributaria.value == '02') {
							scope.notaFiscal.total.icmsTotal.valorPIS = scope.notaFiscal.total.icmsTotal.valorPIS + (_produto.produto.valorTotalBruto * (_produto.tributacao.imposto.pis.percentualAliquota / 100));
							_produto.tributacao.imposto.pis.valorBaseCalculo = _produto.produto.valorTotalBruto;
							_produto.tributacao.imposto.pis.valorTributo = (_produto.produto.valorTotalBruto * (_produto.tributacao.imposto.pis.percentualAliquota / 100))
						}
