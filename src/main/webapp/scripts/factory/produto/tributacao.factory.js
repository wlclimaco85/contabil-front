	...
	commonAuth.factory('fTributacao', ['$rootScope', 'fModels', 'SysMgmtData', function($rootScope, fModels, SysMgmtData)
		{
			...
			factory.fnMontaObjeto = function(tributacao, action, sUrl, callBack)
			{
				...
				if (tributacao.imposto.icms != undefined)
				{
					...
					{
						if (tributacao.imposto.issqn != undefined)
						{
							tributacao.imposto.issqn = new qat.model.NFNotaInfoItemImpostoISSQN(tributacao.imposto.issqn, tributacao.imposto.issqn.id ? action : "INSERT", $rootScope.user.user);
							tributacao.tipo = 1;
						}
				...
				if ((tributacao.imposto.pis != undefined) && (tributacao.imposto.pis.pISSituaTributaria != undefined))
				{
					...
					if ((tributacao.imposto.pis.pISSituaTributaria.value == "04") || (tributacao.imposto.pis.pISSituaTributaria.value == "06") || (tributacao.imposto.pis.pISSituaTributaria.value ==
						...
						(tributacao.imposto.pis.pISSituaTributaria.value == "49") || (tributacao.imposto.pis.pISSituaTributaria.value == "50") || (tributacao.imposto.pis.pISSituaTributaria.value ==
							"51") || (tributacao.imposto.pis.pISSituaTributaria.value == "52") || (tributacao.imposto.pis.pISSituaTributaria.value == "53") || (tributacao.imposto.pis.pISSituaTributaria
							.value == "54") || (tributacao.imposto.pis.pISSituaTributaria.value == "55") || (tributacao.imposto.pis.pISSituaTributaria.value == "56") || (tributacao.imposto.pis.pISSituaTributaria
							.value == "60") || (tributacao.imposto.pis.pISSituaTributaria.value == "61") || (tributacao.imposto.pis.pISSituaTributaria.value == "62") || (tributacao.imposto.pis.pISSituaTributaria
							.value == "63") || (tributacao.imposto.pis.pISSituaTributaria.value == "64") || (tributacao.imposto.pis.pISSituaTributaria.value == "65") || (tributacao.imposto.pis.pISSituaTributaria
							.value == "66") || (tributacao.imposto.pis.pISSituaTributaria.value == "67") || (tributacao.imposto.pis.pISSituaTributaria.value == "70") || (tributacao.imposto.pis.pISSituaTributaria
							.value == "71") || (tributacao.imposto.pis.pISSituaTributaria.value == "72") || (tributacao.imposto.pis.pISSituaTributaria.value == "73") || (tributacao.imposto.pis.pISSituaTributaria
							.value == "74") || (tributacao.imposto.pis.pISSituaTributaria.value == "75"))
					{
